...
public class MensWearFragment extends Fragment
{
    ...
    private void prepareItemsList()
    {
        ...
        ItemsModel itemsModel = new ItemsModel("Printed Casual Shirt", covers[0]);
        itemsModelList.add(itemsModel);
        ItemsModel itemsModel1 = new ItemsModel("Printed Casual Shirt", covers[1]);
        itemsModelList.add(itemsModel1);
        ItemsModel itemsMode2 = new ItemsModel("Printed Casual Shirt", covers[2]);
        itemsModelList.add(itemsMode2);
        ItemsModel itemsMode3 = new ItemsModel("Printed Casual Shirt", covers[3]);
        itemsModelList.add(itemsMode3);
        ItemsModel itemsMode4 = new ItemsModel("Printed Casual Shirt", covers[4]);
        itemsModelList.add(itemsMode4);
        ItemsModel itemsMode5 = new ItemsModel("Printed Casual Shirt", covers[5]);
        itemsModelList.add(itemsMode5);
        ItemsModel itemsMode6 = new ItemsModel("Printed Casual Shirt", covers[6]);
        itemsModelList.add(itemsMode6);
        ItemsModel itemsMode7 = new ItemsModel("Printed Casual Shirt", covers[7]);
        itemsModelList.add(itemsMode7);
        ItemsModel itemsMode8 = new ItemsModel("Printed Casual Shirt", covers[8]);
        itemsModelList.add(itemsMode8);
        ItemsModel itemsMode9 = new ItemsModel("Printed Casual Shirt", covers[9]);
        itemsModelList.add(itemsMode9);
        ItemsModel itemsModel0 = new ItemsModel("Printed Casual Shirt", covers[10]);
        itemsModelList.add(itemsModel0);
        ItemsModel itemsModel12 = new ItemsModel("Printed Casual Shirt", covers[11]);
        itemsModelList.add(itemsModel12);
        ItemsModel itemsModel2 = new ItemsModel("Printed Casual Shirt", covers[12]);
        itemsModelList.add(itemsModel2);
        ItemsModel itemsModel3 = new ItemsModel("Printed Casual Shirt", covers[13]);
